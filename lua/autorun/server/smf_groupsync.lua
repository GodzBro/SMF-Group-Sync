...
--Sync according to SMF/MyBB's groups?
local FORUM_to_ULX = true

--Sync according to ULX groups?
local ULX_to_FORUM = true

--"SteamID" or "IP". If you have "IP" enabled, you don't have
--to have Steam logins setup. This method is dangerous
--if someone has the same IP of the person you are syncing.
